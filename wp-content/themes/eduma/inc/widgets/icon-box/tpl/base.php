...
if ( $instance['icon_type'] == 'text_number' ) {
...
$bg_pos = '';
if ( $instance['layout_group']['style_box'] == 'image_box' && $instance['layout_group']['bg_image_box'] != '' ) {
...
if ( $instance['layout_group']['style_box'] == 'contact_info' && $instance['layout_group']['dot_line'] ) {
...
$prefix = '<div class="wrapper-box-icon' . $extent_class . $class_bg_video . ' ' . $instance['layout_group']['text_align_sc'] . ' ' . $instance['layout_group']['style_box'] . ' ' . $thim_animation . '" ' . $style_bg . ' ' . $data_color . '>';
$suffix = '</div>';
//wrapper-box-icon
...
if ( $boxes_content_style && $instance['icon_type'] != 'text_number' ) {
...
} else if ( $instance['icon_type'] == 'text_number' ) {
	$html_icon .= '<div class="boxes-icon' . $icon_layout . '" ' . $boxes_icon_style . '>' . $complete_prefix . '<span class="inner-icon">';
	$style     = '';
	$style     .= ( $instance['color_group']['icon_color'] != '' ) ? 'color:' . $instance['color_group']['icon_color'] . ';' : '';
	$style     .= ( $instance['text_number_font_size'] != '' ) ? ' font-size:' . $instance['text_number_font_size'] . 'px; line-height:' . $instance['text_number_font_size'] . 'px; vertical-align: middle;' : '';
