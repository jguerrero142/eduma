...
class LP_Addon_Paid_Memberships_Pro extends LP_Addon {
	...
	public function admin_enqueue_scripts() {
		...
		if ( LP_ADDON_PMPRO_DEBUG ) {
			wp_register_script( 'learn-press-pms-script', LP_ADDON_PMPRO_URL . 'assets/admin-lp-pms.js', array(), $v_rand, true );
		} else {
			wp_register_script( 'learn-press-pms-script', LP_ADDON_PMPRO_URL . 'assets/admin-lp-pms.min.js', array(), LP_ADDON_PMPRO_VER, true );
		}
